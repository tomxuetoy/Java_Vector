...
/**
 * <p>Title: 矢量操作</p> <p>Description: 演示一个矢量（Vector）的基本操作</p> <p>Copyright:
 * Copyright (c) 2003</p> <p>Filename: operateVector.java</p>
 *
 * @author 杜江
 * @version 1.0
 */
public class operateVector {
	...
	/**
	 * <br>方法说明：打印输出（过载） <br>输入参数：Object oPara 输出的对象 <br>返回类型：无
	 */
	...
	/**
	 * <br>方法说明：打印输出（过载） <br>输入参数：Vector vPara 显示输出矢量对象 <br>返回类型：无
	 */
	...
	/**
	 * <br>方法说明：主方法，程序入口 <br>输入参数：String[] args <br>返回类型：无
	 */
